      ...
      <div className="w-full max-w-[1440px] px-6 md:px-12 lg:px-16 flex flex-col mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative w-full">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left relative z-10 order-2 lg:order-1">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-normal font-serif text-[#cba865] tracking-tight leading-[1.15] mb-5 max-w-xl">
              {article.title}
            </h1>
            ...
            <Link 
              href={article.href}
              className="inline-flex items-center justify-center bg-[#cba865] text-white font-extrabold text-[11px] tracking-widest uppercase px-8 py-3.5 hover:bg-stone-900 transition-all transform active:scale-98 shadow-sm rounded-full"
            >
              Read More
            </Link>
          </div>
          ...
          <div className="lg:col-span-7 h-[300px] md:h-[400px] lg:h-[460px] w-full relative overflow-hidden bg-stone-100 rounded-2xl shadow-md group isolate order-1 lg:order-2">
            ...
            <div className="absolute inset-x-4 top-1/2 -translate-y-1/2 z-20 flex justify-between pointer-events-none opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
              <button className="w-9 h-9 bg-white/90 backdrop-blur-md text-stone-900 rounded-full flex items-center justify-center hover:bg-[#cba865] hover:text-white pointer-events-auto transition-all shadow-md focus:outline-none cursor-pointer">
