          ...
          <div className="lg:col-span-6 flex flex-col justify-center items-start p-6 md:p-10 lg:p-12 xl:p-14 bg-white border border-gray-100 shadow-xs relative z-20 rounded-2xl">
            ...
            <div className={`w-full transform transition-all duration-700 cubic-bezier(0.34, 1.56, 0.64, 1) ${
              ...
              <div className="flex flex-col mb-4">
                <span className="text-[10px] font-extrabold text-[#cba865] tracking-[0.25em] uppercase block pl-0.5">
              ...
              <Link 
                ...
                className="inline-flex items-center justify-center bg-slate-900 text-white font-extrabold text-xs px-10 py-3.5 shadow-md hover:bg-[#36070E] hover:shadow-xl transition-all transform hover:-translate-y-0.5 active:translate-y-0 duration-200 uppercase tracking-widest min-w-[180px] rounded-full"
              >
