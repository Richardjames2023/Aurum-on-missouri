...
export const ChefSchedule: React.FC = () => {
  return (
    <section className="w-full bg-black py-14 md:py-20 border-b border-gray-100 flex flex-col items-center">
      <div className="w-full max-w-[1440px] px-6 md:px-12 lg:px-16 flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left order-2 lg:order-1">
            <h3 className="text-2xl font-serif font-normal text-[#cba865] tracking-tight leading-tight mb-5">
