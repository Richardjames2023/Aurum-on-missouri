    ...
    <section className="w-full bg-[#FCFBF9] py-16 px-6 md:px-12 lg:px-16 flex flex-col items-center border-b border-stone-100">
      <div className="w-full max-w-[1440px] grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col items-start text-left lg:pr-6">
          ...
          <h1 className="text-3xl md:text-4xl font-normal tracking-tight text-[#cba865] font-serif leading-tight mb-4">
          ...
          <p className="text-stone-600 text-xs md:text-sm font-medium leading-relaxed tracking-wide mb-8 max-w-md">
            Partner with Aurum On Missouri to unlock specialized corporate tariffs, priority luxury event configurations, and tailored executive stays in the Central Business District, Abuja. Submit your inquiry to initiate your custom arrangement.
          </p>
          ...
          <div className="flex flex-col space-y-4 text-xs font-bold text-stone-500 uppercase tracking-wider">
            <div>📍 <span className="text-stone-800 ml-2">8, Missouri Street, Maitama, Abuja.</span></div>
            <div>📧 <span className="text-stone-800 ml-2">info@aurumonmissouri.com</span></div>
            <div>📞 <span className="text-stone-800 ml-2">+234 707 707 1117</span></div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 w-full bg-white border border-gray-100 p-6 md:p-10 shadow-xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full">
            ...
            <button type="submit" disabled={isSubmitting} className="self-start bg-[#cba865] hover:bg-[#36070E] text-white font-extrabold text-xs tracking-widest uppercase px-8 py-3.5 shadow-sm transition-colors duration-200 transform active:scale-98 rounded-none cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center gap-2">
              {isSubmitting ? (
                <>
