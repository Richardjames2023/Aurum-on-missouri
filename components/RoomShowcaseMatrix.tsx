    ...
    <section className="w-full bg-[#1E110E] font-sans flex flex-col items-center">
      <div className="w-full bg-white p-8 md:p-16 shadow-2xl rounded-none">
        ...
        <div className="max-w-[1440px] mx-auto w-full border-b border-gray-100 pb-8 mb-12 flex flex-col lg:flex-row lg:items-end justify-between gap-6 px-6 md:px-12">
          <div>
            <span className="text-[11px] font-extrabold text-[#cba865] uppercase tracking-[0.2em] block mb-2">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-5 py-2.5 border transition-all duration-300 focus:outline-none rounded-none shadow-xs ${
                  activeCategory === cat 
                    ? 'bg-[#cba865] text-white border-[#cba865]' 
            ...
            filteredRooms.map((room) => (
              ...
              >
                ...
                <div className="w-full h-64 md:h-72 relative overflow-hidden bg-stone-100 rounded-t-2xl rounded-b-none isolate">
                  ...
                  <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-md text-[#cba865] font-extrabold text-[10px] tracking-widest uppercase px-3.5 py-1.5 shadow-md border border-white/40 z-30 rounded-md">
                    {room.category}
                  </span>
                  ...
                  <div className="pt-5 border-t border-gray-100 flex items-center justify-between mt-auto">
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-baseline space-x-1">
                        <span className="text-xl font-extrabold text-[#cba865]">
                    ...
                    <button 
                      ...
                      className="inline-flex items-center justify-center bg-slate-900 text-white font-bold text-[11px] uppercase tracking-widest px-6 py-3 hover:bg-[#36070E] transition-all transform active:scale-95 shadow-md rounded-full cursor-pointer"
                    >
